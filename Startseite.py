...
def main():
    ...
    **Metadaten:**  
    Viele mobile Apps löschen aus Sicherheitsgründen die in Dateien eingebetteten Metadaten, wenn sie auf eine Webseite hochgeladen werden. Daher empfehlen wir, diese App auf einem Computer zu verwenden und die Anweisungen im Menü unter "Instrucciones" zu befolgen, um sicherzustellen, dass die App funktioniert.
