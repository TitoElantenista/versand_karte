...
def main():
    ...
    new_uploaded_files = st.file_uploader("Laden Sie Ihre Fotos hoch...", type=['jpg', 'jpeg', 'png'],
    ...
    if st.session_state.uploaded_images:
        ...
        foto_seleccionada = st.selectbox("Seleccione una foto para agregar un comentario:",
