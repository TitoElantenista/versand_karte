...
st.set_page_config(page_title="Startseite")
...
def main():
    ...
    **Kompatibilität:**  
    Obwohl die App mit Samsung-Geräten getestet wurde, sollte sie auch mit anderen Geräten funktionieren. Nichtsdestotrotz empfehlen wir, die App vor einem Projekt zu testen. Bei Problemen können Sie mich unter robertosl.info@gmail.com kontaktieren, damit ich die Kompatibilität Ihres Geräts überprüfen kann.
    ...
    **Foto-Metadaten:**  
    ...
    ![Beispielbild](Hier_der_Link_zum_Bild) *Ein Beispiel für diese Option auf Samsung Android-Geräten.*
    ...
    **Metadaten:**  
    Viele mobile Apps löschen aus Sicherheitsgründen die in Dateien eingebetteten Metadaten, wenn sie auf eine Webseite hochgeladen werden. Daher empfehlen wir, diese App auf einem Computer zu verwenden und die Anweisungen im Menü unter "Anleitung" zu befolgen, um sicherzustellen, dass die App funktioniert.
